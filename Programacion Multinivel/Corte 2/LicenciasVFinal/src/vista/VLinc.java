 ...
 * @author Jhonattan
 */
public class VLinc extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLinc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
