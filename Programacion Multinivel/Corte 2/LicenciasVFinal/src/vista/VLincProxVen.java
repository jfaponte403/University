 ...
 * @author Jhonattan
 */
public class VLincProxVen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LICENCIAS PROXIMAS A VENCER");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLincProxVen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLincProxVen().setVisible(true);
            }
        });
    }
