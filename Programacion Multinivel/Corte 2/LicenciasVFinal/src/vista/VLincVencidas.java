 ...
 * @author Jhonattan
 */
public class VLincVencidas extends javax.swing.JFrame {

    /**
     * Creates new form VRactivas
     */
    public VLincVencidas() {
        initComponents();
        cargarTabla();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLincVencidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLincVencidas().setVisible(true);
            }
        });
    }
