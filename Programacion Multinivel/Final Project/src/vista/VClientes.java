...
public class VClientes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificacion", "Nombres", "Apellidos", "Edad", "Correo"
            }
        ));
        ...
        txtBuscar.setText("Ingrese la identificación");
    ...
    private void btnCrearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCrearMouseClicked
        VAccionCliente ventana = new VAccionCliente(0);
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        VAccionCliente ventana = new VAccionCliente(2);
        ventana.setLocationRelativeTo(null);
        ventana.setVisible(true);
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        VAccionCliente ventana = new VAccionCliente(1);
        ventana.setLocationRelativeTo(null);
        ventana.setVisible(true);
    ...
    private void cargarDatos(String filtro) {
        ...
        try {
            if (clientes != null) {
                ...
                DefaultTableModel tableModel = new DefaultTableModel(new String []{"Identificacion", "Nombres", "Apellidos", "Edad", "Correo"}, size);
                tblClientes.setModel(tableModel);
                
                //Recorrido de datos...
                while (clientes.next()) {
                    tableModel.setValueAt(clientes.getString("identificacion"), i, 0);
                    tableModel.setValueAt(clientes.getString("nombre"), i, 1);
                    tableModel.setValueAt(clientes.getString("apellido"), i, 2);
                    tableModel.setValueAt(clientes.getString("edad"), i, 3);
                    tableModel.setValueAt(clientes.getString("correo"), i, 4);
                    i++;
                }
            } else if (filtro != "") {
