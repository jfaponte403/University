...
public class VVentas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Vendedor", "Moto", "Cliente", "Tipo de Pago", "Fecha", "Monto"
            }
        ));
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        VAccionVenta ventana = new VAccionVenta(2);
        ventana.setLocationRelativeTo(null);
        ventana.setVisible(true);
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        VAccionVenta ventana = new VAccionVenta(1);
        ventana.setLocationRelativeTo(null);
        ventana.setVisible(true);
    ...
    private void cargarDatos(String filtro) {
        ...
        ResultSet clientes = daoVenta.getVenta(filtro);
        int size, i = 0;
        try {
            if (clientes != null) {
                ...
                while (clientes.next()) {
                    String tipoPago = "";
                    switch (clientes.getString("id_tipo_pago")) {
                        case "1":
                            tipoPago = "Credito con sucursal";
                            break;
                        case "2":
                            tipoPago = "Credito con banco";
                            break;
                        case "3":
                            tipoPago = "Efectivo";
                            break;
                    ...
                    tableModel.setValueAt(clientes.getString("id_vendedor"), i, 1);
                    tableModel.setValueAt(clientes.getString("id_moto"), i, 2);
                    tableModel.setValueAt(clientes.getString("id_cliente"), i, 3);
                    tableModel.setValueAt(tipoPago, i, 4);
                    tableModel.setValueAt(clientes.getString("Fecha"), i, 5);
                    tableModel.setValueAt(clientes.getString("Monto"), i, 6);
                    i++;
                }
