 ...
 * @author User
 */
public class VSucursales extends javax.swing.JPanel {
    ...
    private void cargarDatos(String filtro) {
        ...
        try {
            if (sucursales != null) {
                ...
                sucursales.last(); // Mueve el puntero al ultimo dato
                size = sucursales.getRow(); // Obtiene el numero de la fila
                sucursales.beforeFirst(); // Se mueve al inicio
                
                DefaultTableModel tableModel = new DefaultTableModel(new String []{"ID", "NOMBRE", "CIUDAD"}, size);
                tblClientes.setModel(tableModel);
                
                //Recorrido de datos...
                while (sucursales.next()) {
                    tableModel.setValueAt(sucursales.getString("id"), i, 0);
                    tableModel.setValueAt(sucursales.getString("nombre"), i, 1);
