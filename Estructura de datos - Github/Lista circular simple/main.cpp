...
void menu(ListaCircularSimple *&lista);
void cargarEstudiantes(ListaCircularSimple *&);
void mostrarEstudiantes(ListaCircularSimple *&);
void mostrarNotasEstudiante(ListaCircularSimple *&lista);
void crearEstudiante(ListaCircularSimple *&lista);
void eliminarEstudiante(ListaCircularSimple *&lista);
void modificarEstudinte(ListaCircularSimple *&lista);

void cargarEstudiantes(ListaCircularSimple *&lista){
...
void mostrarEstudiantes(ListaCircularSimple *&lista){
